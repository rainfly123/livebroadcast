...
class CreateHandler(tornado.web.RequestHandler):
    def get(self):
        ...
        result['tojson'] =  resp['tojson']
        result['liveid'] =  resp['liveid']
        self.write(cjson.encode(result))
...
class GoodHasLiveHandler(tornado.web.RequestHandler):
    def get(self):
        goodid = self.get_arguments("goodid")
        result = mysql.GoodsLive(goodid[0])
        self.write(cjson.encode(result))
...
application = tornado.web.Application([
    ...
    (r"/goodhaslive", GoodHasLiveHandler),
    (r"/stop", StopHandler),
